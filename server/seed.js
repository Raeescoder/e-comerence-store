// Seed script for adding sample products to the database
...
const products = [
    ...
    },
    {
        ...
        image: 'https://images.unsplash.com/photo-1517668808822-9abb7cb675de?w=500',
        stock: 40,
        rating: 4.6,
        numReviews: 67,
    },
    ...
    {
        name: 'Yoga Mat',
        description: 'Non-slip yoga mat with extra cushioning for comfort during exercises.',
        price: 29.99,
        category: 'Sports',
